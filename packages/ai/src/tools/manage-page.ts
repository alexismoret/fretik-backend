...
const editingDescription = [
  ...
  "- get / list: one page — its manifest (a page is a small Vue project: `Page.vue`, `components/*.vue`, `composables/*.ts`, `page.json`), its data contract, the source of ONE file (`file`, default `Page.vue`), and its recent runtime errors — fix those when present / the team's pages.",
