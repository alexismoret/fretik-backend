...
- `ItemQuantity` — `item_code?: str`, `client_code_id?: str`, `batch_number?: str`, `pallet?: str`, `warehouse_id?: str`, `status_id?: str`, `expiry_date?: str`, `fifo_date?: str`, `su_available?: float`, `su_real_stock?: float`, `su_reserved?: float`, `su_blocked?: float`, `su_stored?: float`, `parcels_available?: float`, `parcels_real_stock?: float`, `full_pallets_available?: float`, `full_pallets_real_stock?: float`, `gross_weight?: float`, `net_weight?: float`
- `StockMovement` — `id?: int`, `item_code?: str`, `client_code_id?: str`, `movement_code?: str`, `movement_type?: str`, `movement_date?: str`, `creation_date?: str`, `batch_number?: str`, `pallet_number?: str`, `location_id?: str`, `status_id?: str`, `sales_unit?: float`, `unit_qty?: float`, `parcels?: float`, `full_pallets?: float`, `reception_id?: int`, `preparation_id?: int`
- `Reception` — `id?: int`, `client_code_id?: str`, `order_reference?: str`, `movement_code_id?: str`, `order_status?: str`, `supplier_name?: str`, `supplier_reference?: str`, `carrier_name?: str`, `planned_receiving_date?: str`, `actual_receiving_date?: str`, `appointment_date?: str`, `arrival_date?: str`, `reception_warehouse_id?: str`, `truck_number?: str`, `number_of_lines?: float`, `number_of_pallets?: float`, `number_of_parcels?: float`, `number_of_sale_units?: float`, `creation_date?: str`, `validation_date?: str`
- `Preparation` — `id?: int`, `client_code_id?: str`, `order_reference?: str`, `client_reference?: str`, `consignee_reference?: str`, `order_status?: str`, `consignee_name?: str`, `consignee_city_name?: str`, `consignee_country_id?: str`, `carrier_name?: str`, `planned_delivery_date?: str`, `imperative_delivery_date?: str`, `planned_preparation_date?: str`, `actual_preparation_date?: str`, `preparation_warehouse_id?: str`, `urgent?: bool`, `number_of_lines?: float`, `number_of_pallets?: float`, `number_of_parcels?: float`, `number_of_sale_units?: float`, `creation_date?: str`, `validation_date?: str`
...
- `Item` — `id?: int`, `item_code?: str`, `client_code_id?: str`, `description?: str`, `external_reference?: str`, `family_code?: str`, `packaging_code?: str`, `unit_code?: str`, `supplier_code_id?: str`, `batch_management?: str`, `available?: bool`, `inner?: float`, `outer?: float`, `layers_per_pallet?: float`, `parcels_per_layer?: float`, `parcel_gross_weight?: float`, `parcel_net_weight?: float`
