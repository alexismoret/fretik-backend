  ...
  types: {
    ...
    ItemQuantity: {
      ...
      client_name: {
        ...
        optional: true,
        description:
          "Warehouse-customer name — the only way to tie a code to a company, since the code is internal to the WMS",
      },
    ...
    Preparation: {
      ...
      urgency_code: {
        type: "string",
        optional: true,
        description: "Urgency level of the order, when the WMS sets one",
      },
      creation_date: { type: "string", optional: true },
      validation_date: { type: "string", optional: true },
    },
    ...
    Item: {
      ...
      client_code_id: {
        type: "string",
        optional: true,
        description: "Warehouse-customer (stockeur) that owns this item",
      },
      client_name: {
        type: "string",
        optional: true,
        description: "Warehouse-customer name — matchable against a document",
      },
