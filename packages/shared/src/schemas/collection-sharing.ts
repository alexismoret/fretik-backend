import { z } from "zod";
import { COLLECTION_PERMISSIONS } from "../db/schema";
...
export const collectionPermissionSchema = z.enum(COLLECTION_PERMISSIONS);
...
export const audienceTeamSchema = z.object({
  teamId: z.uuid(),
  permission: collectionPermissionSchema.default("read"),
});
