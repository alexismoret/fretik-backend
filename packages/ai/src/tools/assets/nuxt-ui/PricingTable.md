...
Parts placed by name: `#caption`, `#tier`, `#tier-title`, `#tier-description`, `#tier-badge`, `#tier-button`, `#tier-billing`, `#tier-discount`, `#tier-price`, `#section-title`, `#feature-title`, `#feature-value`.

Also written in the docs and absent from the interface above — one per column or item: `#team-title`, `#section-security-title`, `#feature-developers-value`.
