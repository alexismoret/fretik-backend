...
Parts placed by name: `#item`, `#item-leading`, `#item-label`, `#item-description`, `#item-trailing`, `#empty`, `#content-top`, `#content-bottom`.

Also written in the docs and absent from the interface above — one per column or item: `#profile-trailing`, `#switch-trailing`.
