/**
 * Key of the one delete-protected system object type. Each record of this type
 * is the 1:1 graph mirror of an uploaded file (`object_records.document_id →
 ...
 */
export const DOCUMENT_TYPE_KEY = "document_record";

/**
 * Hard limits on an object type's own columns. The `description` cap is the
 ...
 */
export const OBJECT_TYPE_LIMITS = {
