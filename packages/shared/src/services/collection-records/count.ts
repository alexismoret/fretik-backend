 ...
 *
 * Affordable because it is on demand and scoped: `collection_records_team_type_status_idx`
 * covers `(team_id, collection_id, status)`, so this is an index-only scan of
